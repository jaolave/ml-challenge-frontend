...
Customer Question: "${userQuestion}"`;
  ...
  return (
    <section>
      <h2 className="text-2xl font-light text-gray-800 mb-2">Questions and answers</h2>

      <h3 className="text-lg font-semibold text-gray-800 mb-2">What do you want to know?</h3>
      
      <h3 className="text-lg font-semibold text-gray-800 mt-2 mb-2">Ask the seller</h3>
      <form onSubmit={handleFormSubmit}>
        <div className="flex items-start md:items-center gap-2 flex-col md:flex-row">
          <textarea
            ...
            disabled={isAsking}
            aria-label="Write your question for the seller"
          ></textarea>
          <button
            type="submit"
      ...
      <h3 className="text-lg font-semibold text-gray-800 mb-2">Last questions</h3>
      {questionsList.length === 0 ? (
        <p className="text-sm text-gray-500">No one has asked a question yet. Be the first!</p>
      ) : (
          ...
          {questionsList.map((qa) => (
            <li key={qa.id} className="text-sm">
              ...
              <div className="flex items-start gap-3 mt-2 pl-6">
                ...
                <div className="flex-1">
                  {qa.answer === null ? (
                    <div className="flex items-center space-x-1" aria-label="Waiting for answer...">
